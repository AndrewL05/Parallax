    ...
    <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-white via-purple-50/30 to-blue-50/50 overflow-hidden">
      ...
      <div className="relative z-10 text-center max-w-7xl mx-auto px-4">
        ...
        >
          ...
          >
            AI-powered life simulation that helps you visualize the long-term outcomes of major 
            decisions. Compare career changes, relocations, and life choices with data-driven insights.
          </motion.p>
        ...
        >
          ...
          >
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-2xl font-bold bg-gradient-to-r from-purple-600 to-blue-600 bg-clip-text text-transparent">Career Change Simulation</h3>
            </div>
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center p-3 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl">
                <span className="text-gray-700 font-medium">5-year salary projection:</span>
              ...
              <div className="flex justify-between items-center p-3 bg-gradient-to-r from-blue-50 to-sky-50 rounded-xl">
                <span className="text-gray-700 font-medium">Happiness score:</span>
                <span className="text-blue-600 font-bold text-lg">8.2/10</span>
              </div>
              <div className="flex justify-between items-center p-3 bg-gradient-to-r from-green-50 to-emerald-50 rounded-xl">
                <span className="text-gray-700 font-medium">Career stability:</span>
          ...
          >
            <div className="flex items-center mb-4">
              ...
              <h3 className="text-2xl font-bold bg-gradient-to-r from-blue-600 to-indigo-600 bg-clip-text text-transparent">Relocation Analysis</h3>
            </div>
            <p className="text-gray-600 mb-6 italic text-lg">
            ...
            <div className="space-y-4">
              <div className="flex justify-between items-center p-3 bg-gradient-to-r from-orange-50 to-amber-50 rounded-xl">
                <span className="text-gray-700 font-medium">Cost of living impact:</span>
              ...
              <div className="flex justify-between items-center p-3 bg-gradient-to-r from-purple-50 to-violet-50 rounded-xl">
                <span className="text-gray-700 font-medium">Network growth:</span>
                <span className="text-purple-600 font-bold text-lg">Strong</span>
              </div>
              <div className="flex justify-between items-center p-3 bg-gradient-to-r from-blue-50 to-sky-50 rounded-xl">
                <span className="text-gray-700 font-medium">Quality of life:</span>
