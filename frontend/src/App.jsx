        ...
        <AnimatePresence mode="wait">
          {currentView === 'home' && (
            ...
            >
              ...
              {/* Simulator Section */}
              <section id="simulator" className="py-20 bg-gradient-to-br from-purple-100 via-blue-50 to-indigo-100">
                <div className="container mx-auto px-4">
                  <div className="text-center mb-12">
                    ...
                    >
                      Start exploring your future possibilities with our AI-powered life simulator
                    </motion.p>
                  </div>
